...
(doom! :input
       ...
       (lookup +dictionary +offline) lookup                   ; navigate your code and its documentation
       (lsp +peek)              ; M-x vscode
       ...
       (org +gnuplot +dragndrop +pandoc +pretty
            +present +noter +roam2) ;; organize your plain life in plain text
       (php +lsp +tree-sitter)          ;; perl's insecure younger brother
       ;;plantuml          ; diagrams for confusing people more
       ;;graphviz          ; diagrams for confusing yourself even more
       ;;purescript        ; javascript, but functional
       (python +lsp +pyright
               +tree-sitter +cython)    ; beautiful is better than ugly
